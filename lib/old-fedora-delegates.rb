...
class CustomDelegate
  ...
  def check_sinai_cookies
    #### look at the cookies and try to make sense of them
    # assume we are looking for two cookies: initialization_vector and sinai_authenticated
    # can we see the cookies?
    # can initialization_vector be used to decypher the sinai_authenticated key?
    # doe sinai_authenticated equal ENV.CIPHER_KEY ?
